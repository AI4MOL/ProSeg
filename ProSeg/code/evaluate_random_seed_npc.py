...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", type=str, default='/mnt/nas/share2/home/liuke/prj/D-Persona-main/D-Persona/models/pionono_prob01_2_NPC_20250805-005305', help="save path")
    ...
    net.cuda()
    args.save_path = os.path.join("/mnt/nas/share2/home/liuke/prj/D-Persona-main/D-Persona/models/aaa_random_test", '{}_{}_seed'.format(args.model_name, opt.DATASET))
    ...
    with open(args.save_path + f'performance_N=50_{random_seed}.txt', 'w') as f:
