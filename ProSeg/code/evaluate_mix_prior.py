...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type=str, default='pionono_mix')
    ...
    for fold_idx in range(opt.KFOLD):
        ...
        result_path = args.save_path + 'prior_results_{}_fold/'.format(fold_idx)
